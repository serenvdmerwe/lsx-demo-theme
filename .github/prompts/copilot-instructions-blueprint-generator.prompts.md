...
To create the copilot-instructions.md file, first analyse the codebase to:
...
2. **Understand Architecture**:
   - Analyse folder structure and module organization
...
4. **Note Quality Standards**:
   - Identify performance optimisation techniques actually used
